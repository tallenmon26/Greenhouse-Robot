...
System Workflow
Perception: The OAK-D Lite captures RGB and depth data.

Processing: The Raspberry Pi runs OpenCV scripts to filter the environment and calculate trajectory vectors.

Command: Vectors are translated into motor speeds and sent via serial connection to the Arduino.

Actuation: The Arduino triggers the Sabertooth drivers to adjust the DC motors accordingly.
...
From the Pi's terminal, execute the main vision logic: python3 Obstacle_Logic.py
